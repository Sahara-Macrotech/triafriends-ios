...
//  triafriends
//
//  Created by Iswandi Saputra on 03/11/20.
//
...
struct CalenderUIView : View {
    ...
    @State var minDate = DatePickerHelper.shared.dateFrom(day: 18, month: 08, year: 1990)!
...
//    var minimumDate: Date = Date.dateFromString("1900-01-01")!
    var rkManager1 = RKManager(calendar:Calendar.current, minimumDate: Date()-2000, maximumDate: Date().addingTimeInterval(60*60*24*365), mode: 0)
